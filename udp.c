...
struct udp_layer {//lo q necesita ip para poder funcionar contiene todas las capas de abajo
...
//INICIALIZAMOS LA ESTRUCTURA
    ...
    memcpy(udp_frame.data, payload, payload_len);
...
int udp_recv(udp_layer_t udp_layer,unsigned char buffer []/*uint16_t src_port*/, ipv4_addr_t sender, int buffer_len, long int timeout){//logica de los puertos?hay q pensar hacia arriba--------------------------------------------------------------------
