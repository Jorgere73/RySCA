...
ipv4_server: ipv4_server.c ipv4.c ipv4.h ipv4_config.c ipv4_config.h ipv4_route_table.c ipv4_route_table.h eth.c eth.h header.h log.c log.h
	rawnetcc ipv4_server ipv4.c eth.c arp.c ipv4_config.c ipv4_route_table.c log.c ipv4_server.c